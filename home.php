...
<section class="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide" style="background:url(images/tt.jpg) no-repeat">
            <div class="content">
         ...
         <div class="swiper-slide slide" style="background:url(https://t4.ftcdn.net/jpg/02/74/45/17/240_F_274451707_jZJ4Swvhj97cp88SjX3mnhX549BB3Lgc.jpg) no-repeat">
            <div class="content">
               <span>explore, discover, travel</span>
